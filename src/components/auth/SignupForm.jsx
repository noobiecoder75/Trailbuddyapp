...
const SignupForm = () => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Note: OAuth redirects automatically, so we don't navigate manually
    } catch (error) {
      console.error('SignupForm: Google sign up error:', error)
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition-all duration-200 font-medium"
      >
