          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <Link to="/analysis">
              <Card className="text-center hover:shadow-md transition-shadow cursor-pointer">
                ...
                <h3 className="text-lg font-semibold text-mountain-900 mb-2">Health Analysis</h3>
                <p className="text-mountain-600 text-sm">View detailed insights from your fitness data and matching criteria</p>
              </Card>
            </Link>
            ...
            <Card className="text-center">
              ...
              <p className="text-mountain-600 text-sm">See your activities and achievements integrated with health apps</p>
            </Card>
          </div>
